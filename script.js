...
function animateOne() {
  ...
  if(circle.style.animationPlayState === "paused"){
    // we want to start animation playback when clicked
...
function animateTwo() {
  ...
  let animFrames = [
    {transfrom: "translateX(10vh)", scale: 3},
    {transfrom: "translateX(-10vh)", scale: 2},
    {transfrom: "translateX(3vh)", scale: 1},
    {transfrom: "translateX(-6vh)", scale: 3}
  ];
...
function animateThree() {
  ...
  // create the keyframes
  let animFrames = [
    {transfrom: `translateX(${10 * randomMod}vh)`, scale: 3},
    {transfrom: "translateX(-10vh)", scale: 2},
    {transfrom: "translateX(3vh)", scale: 1},
    {transfrom: "translateX(-6vh)", scale: 3}
  ];
